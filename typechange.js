onSwitchIn: function (pokemon) {
       let changed = {'Blastoise-Mega':true, 'Chimecho': true, 'Arbok':true, 'Meganium':true, 'Feraligatr':true, 'Sunfora':true, 'Granbull':true, 'Ursaring':true, 'Bellossom':true, 'Noctowl':true, 'Volbeat':true, 'Blastoise-Mega':true, 'Illumise':true, 'Absol-Mega':true, 'Luvdisc':true, 'Milotic':true, 'Tropius':true, 'Flygon':true, 'Luxray':true, 'Cherrim-Sunshine':true, 'Aromatisse':true};
