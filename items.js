...
let BattleItems = {
	...
	"armorfossil": {
		...
		onModifyAtk(atk, pokemon) {
			if (pokemon.baseTemplate.baseSpecies === 'Bastiodon') {
		...
		num: 104,
		gen: 4,
		desc: "If held by Bastiodon it's attacking stats are doubled.",
	},
	"aspearberry": {
		id: "aspearberry",
		name: "Aspear Berry",
	...
	"deepseascale": {
		...
		onModifySpD(spd, pokemon) {
			if (pokemon.baseTemplate.species === 'Clamperl' || pokemon.baseTemplate.baseSpecies === 'Gorebyss' || pokemon.baseTemplate.baseSpecies === 'Huntail') {
				return this.chainModify(2);
			}
		},
		num: 227,
	...
	"dragonscale": {
		...
		onModifyAtkPriority: 1,
		onModifyAtk(atk, pokemon) {
			if (pokemon.baseTemplate.baseSpecies === 'Kingdra') {
				return this.chainModify(2);
			}
		},
		onModifySpAPriority: 1,
	...
	"skullfossil": {
		...
		onModifyDefPriority: 1,
		onModifyDef(def, pokemon) {
			if (pokemon.baseTemplate.baseSpecies === 'Rampardos') {
				return this.chainModify(2);
			}
		},
		onModifySpDPriority: 1,
